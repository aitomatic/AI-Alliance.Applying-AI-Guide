...
pages_url    := https://the-ai-alliance.github.io/applying-ai-guide/
docs_dir     := docs
...
define help_message
Quick help for applying-ai-guide make process.
...
# `localhost:4000/The-AI-Alliance/applying-ai-guide` when -ping locally.
run-jekyll:
	@echo
